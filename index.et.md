...
10.03.2022 | 22.03/1  | Uuendatud versioon, baseerub EID-22.1.0.1922 tarkvaral.
           |          | Muutja: Urmas Vanem
14.09.2022 | 22.09/1  | Lisatud uute Microsoft poolsete nõuete kirjeldus kasutaja ja eID kaardi sertifikaadi sidumiseks.
           |          | Muutja: Urmas Vanem
11.12.2023 | 23.12/1  | Eemaldatud ESTEID-SK 2015 ahel + väiksed muutused.
           |          | Muutja: Urmas Vanem
31.10.2025 | 25.10/1  | Lisatud Zetes ahelad
           |          | Muutja: Raul Kaidro
...
*   Klientarvutitel peab olema installeeritud ID-tarkvara (täna, novembris 2025, soovitame kõige värskeimat versiooni 25.10.23.8403).
...
*   EE-GovCA2018 - usaldusväärne juursertifikaat;
*   EEGovCA2025 - usaldusväärne juursertifikaat;
*   ESTEID2018 - usaldusväärne kesktaseme sertifikaat;
*   ESTEID2025 - usaldusväärne kesktaseme sertifikaat.
...
1.  Küsida kasutaja sertifikaat LDAP kataloogiteenusest isikukoodi alusel. Soovi korral saab seda teha ka DigiDoc4 kliendi abil.
...
**Tuleb märkida, et nii `issuer`'i kui `seerianumbri` stringid tuleb sidumisel ümber keerata!** See tähendab, et kui:
...
![<I> ja <SR> viitavad sertifikaadi väljadele Issuer ja SerialNumber.](./img/image13.png)
...
Administraatorite ja kasutajatoe vaade on arvatavasti samuti positiivne, kuna lisaks turvalisuse kasvule esineb vähem probleeme paroolide unustamisega kasutajate poolt. Samuti on vastava konfiguratsiooni loomine küllaltki lihtne. Ja huvitav :)
